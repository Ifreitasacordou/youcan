...
module.exports = function(bp) {
  ...
  bp.hear({
    type: /message|text/i,
    text: /desafios em aberto|desafios abertos|em aberto|em abertos/i
  }, (event, next) => {
    event.reply('#aberto', {
      // You can pass data to the UMM bloc!
      reason: 'unknown'
  ...
  bp.hear({
    type: /message|text/i,
    text: /desafios em andamento|em andamento/i
  }, (event, next) => {
    event.reply('#andamento', {
      // You can pass data to the UMM bloc!
      reason: 'unknown'
    })
  })
  ...
  bp.hear({
    type: /message|text/i,
    text: /desafios encerrados|encerrados/i
  }, (event, next) => {
    event.reply('#encerrado', {
      // You can pass data to the UMM bloc!
      reason: 'unknown'
    })
  })
